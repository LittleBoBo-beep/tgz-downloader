...
class Crawler {
	...
	/**
	 * 获取dependencies
	 * @param { {name: string, version: string, devDependencies?: boolean, peerDependencies?: boolean, registry?: string, isMoreVersion?: boolean, devDependencies?: boolean, peerDependencies?: boolean} }options
	 * @return {Set<string>}
	 */
